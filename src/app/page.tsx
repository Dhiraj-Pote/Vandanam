...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="mangalacaran"
        className="mb-24 bg-[#f3d4a5] rounded-lg p-10 shadow-lg text-center"
      >
        <h1 className="text-3xl font-bold mb-12 text-[#5a3a1a] inline-block border-b-4 border-[#da9d5b] pb-2">
      ...
      <section
        ...
        className="mb-24 bg-[#f3d4a5] rounded-lg p-10 shadow-lg text-center"
      >
        <h1 className="text-3xl font-bold mb-4 text-[#5a3a1a] inline-block border-b-4 border-[#da9d5b] pb-2">
          Śikṣāṣṭakam
        </h1>
        <p className="mb-10 italic text-base text-[#6b4423]">
      ...
      <section
        ...
        className="mb-24 bg-[#f3d4a5] rounded-lg p-10 shadow-lg text-center"
      >
        <h1 className="text-3xl font-bold mb-3 text-[#5a3a1a] inline-block border-b-4 border-[#da9d5b] pb-2">
          Ten Offenses While Chanting
        </h1>
        <p className="mb-12 italic text-base text-[#6b4423]">
